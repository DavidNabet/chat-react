...
gulp.task('css', function() {  // Tache permettant de minifier toutes les feuilles de style en un seul fichier min "style.min.css"
    return gulp.src(
        [
...
gulp.task('watch', function() { // Détecter tous les changements en tapant la commande "gulp watch" dans le terminal
...
gulp.task('default', gulp.series('sass', 'css', 'js', 'fonts', 'image', 'replaceName'));